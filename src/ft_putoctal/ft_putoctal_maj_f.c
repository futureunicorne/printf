...
/*   Updated: 2017/02/07 22:15:56 by hel-hadi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_putoctal_0(char *s, int arg)
{
	...
	if (ft_check_point(s) && ft_check_point(s) && !ft_check_dieses(s))
	{
		ptr.nb = 0;
		ptr.flag = 1;
	}
	...
	if (ft_check_dieses(s) && !ft_record_prec(s) && ft_record_chain(s))
	{
		ft_putchar('0');
		ptr.val++;
	}
